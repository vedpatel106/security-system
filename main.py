...
class SecuritySystem:
    def __init__(self, main_menu_window):
        ...
        self.security_system_active = False  # Initially, the security system is turned off
...
class LoginWindow:
    def __init__(self, root):
        ...
        style = ttk.Style()
        style.configure("TButton", background=BUTTON_BG_COLOUR, foreground=BUTTON_FG_COLOUR, font=(MAIN_FONT, 10),
...
class MainMenuWindow:
    def __init__(self, root, login_window):
        ...
        self.security_button = ttk.Button(root, textvariable=self.security_button_text, command=self.toggle_security_system,
                                         style="TButton", width=20, cursor="hand2")
        self.security_button.pack(pady=5)

        self.security_system = SecuritySystem(self)  # Pass the MainMenuWindow instance to SecuritySystem
    ...
    def open_live_view(self):
        ...
        # Add the live feed of the camera here
    ...
    def exit_program(root, login_window):
        if login_window.security_system.security_system_active:
            login_window.security_system.release_camera()
        root.destroy()
